...
namespace Ken120.Web.Mvc.Infrastructure.Caching
{
    ...
    public class PagesCacheDependencyAttribute : CacheDependencyAttribute
    {
        ...
        private readonly string pageTypeClassName;
        ...
        public PagesCacheDependencyAttribute(string pageTypeClassName)
            : base(KEY_FORMAT) => this.pageTypeClassName = pageTypeClassName;
        ...
        internal override string ResolveKey(string siteName, object[] methodArguments) => string.Format(KEY_FORMAT, siteName, pageTypeClassName);
    }
}
